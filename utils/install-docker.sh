...
cloneconfig() {
  echo "Cloning Nvim kali-nvim configuration"
  git clone https://github.com/jdcrooke/kali-nvim.git ~/.config/nvim
}
...
# Welcome
echo 'Installing Nvim kali-nvim'
...
# echo "Nvim kali-nvim is better with at least ripgrep, ueberzug and ranger"
